...
contains(Sk21_NEED_QT_PLUGINS, 1) {
    DEFINES += Sk21_NEED_QT_PLUGINS
...
# Gross ugly Sk21 that depends on qmake internals, unfortunately there is no other way to do it.
...
SOURCES += src/qt/sk21.cpp src/qt/sk21gui.cpp \
    ...
    src/qt/sk21addressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/sk21strings.cpp \
    src/qt/sk21amountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/sk21.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/sk21_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/sk21-qt.rc
...
windows:RC_FILE = src/qt/res/sk21-qt.rc
RC_ICONS = sk21.ico
...
macx:ICON = src/qt/res/icons/sk21.icns
macx:TARGET = "sk21-Qt"
